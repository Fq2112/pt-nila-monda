...
@push('scripts')
    ...
    <script>
        ...
        function init() {
            var myLatlng = new google.maps.LatLng(-7.5371207, 110.5875433);
            ...
            var contentString =
                '<div id="iw-container">' +
                '<div class="iw-title">PT. NILA MONDA</div>' +
                '<div class="iw-content">' +
                '<img class="img-fluid" src="{{asset('images/logo/icon.png')}}">' +
                '<div class="iw-subTitle">Contacts</div>' +
                '<p>Jl. Perintis Kemerdekaan No.03 Pulisen, Boyolali, Jawa Tengah, Indonesia — 57311.<br>' +
                '<br>Phone: <a href="tel:+62276321290">(0276) 321290</a>' +
